...
<form class="" method="POST" action="/register/manager" enctype="multipart/form-data" style="position: absolute; top:10%; left:0%; right:0%">
        ...
        <div class="form-group container ">
            ...
            <input type="Text" class="form-control" id="name" name="name" placeholder="Enter manager name" required pattern="[A-Za-z ‘-]{2,}">
        </div>

        <div class="form-group container ">
            <label for="surname" class="text-muted">Surname</label>
            <input type="Text" class="form-control" id="surname" name="surname" placeholder="Enter manager surname" required pattern="[A-Za-z ‘-]{2,}">
        </div>
