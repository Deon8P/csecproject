...
<div class="topnav">
    ...
    <a href="/manager/application/history">Application History</a>
...
@section('content')
    ...
    @else
    <h1 class="text-center" style="color: #c5c5c5;">There are no applications to process at this momment.</h1>
    @endif
